...
export type Stroke={id:string;color:string;width:number;erase:boolean;points:Point[];brush?:"pen"|"pencil"|"air"|"warp";opacity?:number;fillRuns?:number[];layer?:DrawingLayer;photo?:Blob;sticker?:import('./sketchbook-stickers').StickerKind}
