...
const TOOLS=[{id:'pen',label:'펜',Icon:PenTool},{id:'pencil',label:'크레파스',Icon:Crayon},{id:'air',label:'에어브러시',Icon:SprayCan},{id:'erase',label:'지우개',Icon:Eraser},{id:'fill',label:'채우기',Icon:PaintBucket},{id:'lasso',label:'선택',Icon:LassoSelect},{id:'pick',label:'스포이드',Icon:Pipette}] as const
