...
export default function Page(){
  ...
  const submit=(input:StoryInput)=>{void generation.start(currentProfile.id,input).catch(e=>toast.error(e instanceof Error?e.message:'동화를 시작하지 못했어요.'));router.push('/dashboard')}
